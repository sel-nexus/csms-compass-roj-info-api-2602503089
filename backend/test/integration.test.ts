...
const config={port:8000,maxRequestBytes:256,apiKeys:["valid-key"],allowedOrigins:["http://localhost:5173"],compassBaseUrl:"http://localhost:9000",compassCredential:"test",nodeEnv:"test" as const};
